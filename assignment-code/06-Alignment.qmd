...
## All code provided by SR - will adjust after I can work the workflow
...
## I've made adjustments to the OG code, i think i have to make the index
```{r, engine='bash'}
/home/shared/hisat2-2.2.1/hisat2 \
-x /home/shared/8TB_HDD_02/cnmntgna/GitHub/chris-coursework1/data/cgigas_uk_roslin_v1_genomic-mito.index \
-p 4 \
