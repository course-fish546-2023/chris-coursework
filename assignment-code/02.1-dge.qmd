...
## This Bash code runs the 'abundance_estimates' script from the Trinity RNA-seq package and creates a gene expression matrix from the output of Kallisto quantification results.
